...
public class ParseEx extends RuntimeException {
    public ParseEx(FeatureInputStream fin, String message) { super(m(fin,message)); }
    public ParseEx(FeatureInputStream fin, String message, Exception y) { super(m(fin,message), y); }
